...
export default function BottomNavigation() {
  ...
  const shouldShowNavigation = () => {
    ...
    if (location.includes('/transfer') || location.includes('/iban-transfer') || location.includes('/uk-transfer') || location.includes('/clabe-transfer') || location.includes('/email-transfer') || location.includes('/internal-transfer')) return false;
