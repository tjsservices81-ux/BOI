          ...
          setTimeout(async () => {
            try {
              ...
              const newTransaction = {
                ...
                description: `UK Transfer to ${formData.recipientName}`,
                category: 'transfer',
                type: 'debit',
              ...
              console.log(`✅ Transfer completed locally: ${formData.amount} to ${formData.recipientName}`);
              ...
              fetch('/api/lookup-account/uk', {
                ...
                if (lookupResult.found && lookupResult.isInternal) {
                  ...
                  console.log('📲 Internal transfer detected, syncing recipient...');
                  fetch('/api/internal-transfer', {
                    ...
                    console.log('💾 Internal transfer synced to database');
                  }).catch((err) => {
                    console.warn('⚠️ Internal transfer sync failed:', err);
                  });
                }
              }).catch(() => {
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '0.75rem', padding: '1.5rem', marginBottom: '2rem' }}>
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500" style={{ fontFamily: 'OpenSans, sans-serif' }}>Transfer via Faster Payments</p>
            </div>
          </div>
