      ...
      <div className="bg-white border-t border-gray-200 ios-safe-bottom">
        ...
        <div className="px-4 pt-4 pb-2">
          <div className="grid grid-cols-2 gap-3">
            <button 
              className="bg-[#4a6b75] text-white py-3 px-4 rounded-lg font-medium boi-semibold-font hover:bg-[#3a5963] transition-colors haptic-feedback"
              onClick={() => alert('Transfer Money: Send money to another account or external bank')}
            >
              Transfer
            </button>
            <button 
              className="border border-[#4a6b75] text-[#4a6b75] py-3 px-4 rounded-lg font-medium boi-semibold-font hover:bg-[#4a6b75] hover:text-white transition-colors haptic-feedback"
        ...
        <div className="px-4 pb-4">
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              <svg className="w-5 h-5 text-[#4a6b75] mb-1" fill="currentColor" viewBox="0 0 20 20">
