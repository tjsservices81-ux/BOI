...
export default function Dashboard() {
  return (
    <div className="h-screen bg-gray-50 overflow-hidden flex flex-col ios-safe-top ios-safe-bottom ios-safe-left ios-safe-right">
      ...
      <div className="text-white relative flex-shrink-0 h-40">
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="px-4 pb-6 mt-auto">
            ...
            <p className="text-white/70 text-sm boi-regular-font mt-1">Last login: 14.07 GMT 27/04/2021</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-t-xl shadow-sm">
          ...
          >
            <div className="text-left">
              <p className="font-semibold text-sm text-gray-800 boi-semibold-font">CURRENT ACCOUNT</p>
              <p className="text-xs text-gray-500 mt-1 boi-regular-font">-2091</p>
            </div>
          ...
          >
            <div className="text-left">
              <p className="font-semibold text-sm text-gray-800 boi-semibold-font">CREDIT CARD</p>
              <p className="text-xs text-gray-500 mt-1 boi-regular-font">-1820</p>
            </div>
            <div className="flex items-center">
          ...
          >
            <div className="text-left">
              <p className="font-semibold text-sm text-gray-800 boi-semibold-font">SAVINGS ACCOUNT</p>
              <p className="text-xs text-gray-500 mt-1 boi-regular-font">-0978</p>
            </div>
            <div className="flex items-center">
          ...
          >
            <div className="text-left">
              <p className="font-semibold text-sm text-gray-800 boi-semibold-font">PERSONAL LOAN</p>
              <p className="text-xs text-gray-500 mt-1 boi-regular-font">-8923</p>
            </div>
            <div className="flex items-center">
          ...
          >
            <div className="text-left">
              <p className="font-semibold text-sm text-gray-800 boi-semibold-font">DEPOSIT - 7908</p>
              <p className="text-xs text-[#4a6b75] mt-1 boi-regular-font">365 MONTHLY SAVER</p>
            </div>
            <div className="flex items-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 pb-safe">
        <div className="flex">
          <button className="flex-1 flex flex-col items-center py-4 text-[#4a6b75] relative">
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-[#4a6b75]"></div>
          </button>
          
          <button 
            className="flex-1 flex flex-col items-center py-4 text-gray-400 hover:text-[#4a6b75] transition-colors"
          ...
          >
            <img src="/credit_card_services.svg" alt="Cards" className="w-5 h-5 mb-1" />
