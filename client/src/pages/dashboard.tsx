...
export default function Dashboard() {
  ...
  return (
    <div className="page-container h-screen bg-white overflow-hidden flex flex-col ios-safe-bottom relative">
      {/* First-run: welcome a newly set-up account with what works and what's
          being fixed. Sits above the notification prompt (higher z-index), so a
          brand-new person sees this first, then the notifications ask. Shows
          once per account. */}
      <WelcomeOnboard />
