        ...
        <div className="bg-white rounded-t-2xl pt-6">
          ...
          <div className="space-y-4 px-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
              ...
              <p className="text-xs text-gray-600 mb-4 boi-regular-font">You're 60% towards your {CurrencyManager.formatAmount('5000', currentCurrency)} holiday savings goal</p>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                ...
                <div className="flex justify-between">
                  <span className="text-xs text-green-700 boi-regular-font">{CurrencyManager.formatAmount('3000', currentCurrency)} saved</span>
                  <span className="text-xs text-green-700 boi-regular-font">{CurrencyManager.formatAmount('5000', currentCurrency)} goal</span>
                </div>
              </div>
            </div>
          </div>
