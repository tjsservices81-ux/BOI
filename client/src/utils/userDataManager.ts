...
export class UserDataManager {
  ...
  static addRecentPayee(payee: { name: string; accountInfo: string; transferType: string; timestamp: string; reference?: string; bicCode?: string; bankName?: string; country?: string }) {
