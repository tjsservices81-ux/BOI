...
async function create3FreshCodes() {
  console.log('🔑 CREATING 3 FRESH BOI ACCESS CODES\n');
  
  // Generate 3 BOI codes with 6 random numbers
  const codes = [];
  ...
  if (successful === total) {
    console.log('\n🎉 FRESH BOI CODES CREATED SUCCESSFULLY');
    console.log('✅ 3 unique BOI codes with 6 numbers each');
...
create3FreshCodes().catch(console.error);