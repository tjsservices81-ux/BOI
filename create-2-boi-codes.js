...
async function create2BOICodes() {
  console.log('🔑 CREATING 2 NEW BOI ACCESS CODES\n');
  ...
  if (successful === total) {
    ...
    console.log('✅ 2 unique BOI codes with 6 numbers each');
...
create2BOICodes().catch(console.error);