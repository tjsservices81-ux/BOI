...
document.getElementById('loc-\${escapeHtml(c.customerNumber)}').textContent='📍 '+loc;
}
}catch(e){}
})();
</script>
...
async function showMap(lat,lng,name){
